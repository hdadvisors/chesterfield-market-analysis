...
```{r cf-rents, fig.cap="Average asking rent in Chesterfield County: 2000 Q1 to 2022 Q2"}
...
bedroom_rent %>% 
  kable(caption = "Calculated income needed to afford average rents by bedroom in Chesterfield County",
        align = "lrr",
