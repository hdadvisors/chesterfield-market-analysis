...
ggplot(race_cb,
  ...
  theme(axis.title = element_blank(),
        axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1)) +
  scale_y_continuous(labels = percent_format()) +
  labs(title = "Household cost burden by race or ethnicity", fill = "Cost burden")
#   
...
#| fig-subcap: "Source: U.S. Census Bureau, American Community Survey, 5-year estimates. Public Use Microdata Sample."
...
#| fig-subcap: "Source: U.S. Census Bureau, American Community Survey, 2016-2020 5-year estimates. Public Use Microdata Sample."
...
#| fig-subcap: "Source: U.S. Census Bureau, American Community Survey, 2016-2020 5-year estimates. Table B25106."
