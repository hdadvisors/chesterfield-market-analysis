...
r1_otm %>% 
  ...
  kableExtra::footnote(general = "U.S. Census Bureau. (2022). LEHD Origin-Destination \nEmployment Statistics (2002-2019). Longitudinal-Employer Household Dynamics Program.",
...
r1_otm %>% 
  ...
  kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed"),
      latex_options = c("striped"))  %>% 
  kableExtra::footnote(general = "U.S. Bureau of Labor Statistics. (2021). Occupational Employment \nand Wage Statistics (OEWS). May 2021 Metropolitan and \nNonmetropolitan Area Occupational Employment and Wage Estimates.",
                       general_title = "Source: ",
                       footnote_as_chunk = T)
