...
#   ))
# 
# write_rds(r1_tracts, "data/r1_tracts.rds")
...
r1_otm %>% 
  ...
  kableExtra::footnote(general = "U.S. Census Bureau. (2022). LEHD Origin-Destination Employment Statistics (2002-2019). Longitudinal-Employer Household Dynamics Program.",
...
r1_otm %>% 
  ...
  kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed"),
      latex_options = c("striped"))  %>% 
  kableExtra::footnote(general = "U.S. Bureau of Labor Statistics. (2021). Occupational Employment and Wage Statistics (OEWS). May 2021 Metropolitan and Nonmetropolitan Area Occupational Employment and Wage Estimates.",
                       general_title = "Source: ",
                       footnote_as_chunk = T,
                       threeparttable = T)
...
gg_line(r1_sales_med,
        ...
        caption = "Source: CVR MLS. 2022 includes all sales through September 6, 2022.",
...
ggplot(r1_sales_tract,
       aes(x = year,
           y = median,
           color = neighborhood)) +
  geom_line(size = 1) +
  facet_wrap(~NAME, ncol = 3) +
  labs(title = "Median single-family home sales price by Census tract",
       caption = "Source: CVR MLS. 2022 includes all sales through September 5, 2022.",
...
r1_otm %>% 
  ...
  kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed"),
      latex_options = c("striped")) %>% 
  kableExtra::footnote(general = "Freddie Mac Primary Mortgage Market Survey and Bureau of Labor Statistics, Occupational Employment and Wage Statistics, May 2021.",
                       general_title = "Sources: ",
                       footnote_as_chunk = T,
                       threeparttable = T)
...
pal <- colorNumeric(palette = "viridis", domain = r1_rentals$askingrent, reverse = TRUE)

leaflet(r1_rentals) |>
  addProviderTiles(providers$CartoDB.Positron) |>
  addCircleMarkers(
    radius = 5,
    fillColor = ~pal(askingrent),
    stroke = TRUE,
    weight = 1,
    color = "black",
    fillOpacity = 0.5
  ) |>
  addLegend("topright", pal = pal, values = ~askingrent,
            title = "Asking rent", opacity = 1,
...
::: {.content-visible when-format="pdf"}
![Asking rent by rental property](images/fig-rents-tract.png)
:::
...
#| tbl-cap: "Maximum monthly rent for common occupations in the study area"
