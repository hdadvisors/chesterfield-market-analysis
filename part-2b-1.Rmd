...
```{r r1-jobs-chart, fig.cap="Percent of jobs by wage within 15 minute drive of apartments by rent type in the Route 1 corridor"}
...
gg_hbar_col(sfr_mls_bar,
            ...
            y_title = "",
            col_title = "",
            title = "Renter income and income needed to purchase or rent single-family home in Route 1 corridor"
            ) +
  ggplot2::geom_text(
