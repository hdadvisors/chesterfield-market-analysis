...
Along the northern Route 1 corridor, there is an estimated 1,012 single-family home rentals --- about 20 percent of all single-family homes the area.^[This analysis was conducted by matching owner mailing address to physical address for all parcels wherein the land use code is "Single Dwelling." This analysis does not account for condominiums and therefore could be considered an undercount.] The highest concentration of SFR is within Census Tract 1003 (Ampthill), where 28 percent of all single-family homes are believed to be renter occupied.

SFR is a growing demand among renters as homeownership continues to be out of reach for many, but it also serves a growing demand among households looking for greater space and privacy not offered in apartments. As seen in [Chapter 13](#part-2a-3), nearly 54 percent of recent multifamily housing is two-bedrooms or less, leaving many larger households competing for less supply. SFR is largely filling the gap where multifamily developers are often falling short due to increasing construction costs and public opposition.
