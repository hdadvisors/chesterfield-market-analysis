...
```{r sfr-r1, fig.cap="Percent of single-family homes that are renter-occupied by tract and neigborhood", message=FALSE}
...
```{r sfr_r1_owners, fig.cap="Owner location for single-family rentals along Route 1 corridor"}
...
rental_class_r1_sum |> 
  kable(caption = "Owner location for single-family rentals along Route 1 corridor",
        align = "lrr",
...
```{r the-jane, fig.cap="The Jane at Moore's Lake. Credit: Apartment Finder."}

knitr::include_graphics("images/thejane.jpg")
...
```{r moores-lake, fig.cap="Proposed site plan for Moore's Lake development. Credit: Richmond BizSense."}

knitr::include_graphics("images/mooreslakesite.jpg")
