...
renters_plot <- ggplot(b25003_data, 
                       aes(x = year,
                           y = estimate)) +
  geom_line(color = "blue") + 
  geom_point(color = "blue") +
  scale_y_continuous(n.breaks = 5, limits = c(0, 35000), labels = dollar_format()) +
  labs(title = "Renter households",
  caption = "Source: U.S. Census Bureau. American Community Survey. 2010-2020 5-year estimates. Table B25003.") +
...
structure_plot <- gg_bar_col(
  ...
  caption = "Source: U.S. Census Bureau. American Community Survey. 2010-2020 5-year estimates. Table B25032.",
...
b25042_data <- b25042_raw |> 
  ...
  mutate(bedrooms = case_when(
    bedrooms == "5 or more bedrooms" ~ "5+ bedrooms",
    TRUE ~ bedrooms
  ))

bedroom_plot <- ggplot(b25042_data,
                       aes(x = year,
                           y = estimate, 
                           fill = bedrooms)) +
  geom_col(width = .6) +
  facet_wrap(~bedrooms) +
  labs(title = "Rental housing by bedrooms",
       caption = "Source: U.S. Census Bureau. American Community Survey. 2010-2020 5-year estimates. Table B25042.",
       y = "Renter-occupied housing units") +
  theme(axis.title.x = element_blank(), 
        legend.position = "none") +
  scale_x_continuous(n.breaks = 3, labels = number_format(accuracy = 1, big.mark = "")) +
  scale_y_continuous(n.breaks = 5, labels = number_format(big.mark = ","))
...
built_plot <- ggplot(b25036_data,
  ...
  theme(axis.title = element_blank(),
        legend.position = "none") +
  labs(title = "Rental housing by year built",
       caption = "Source: U.S. Census Bureau. American Community Survey. 2010-2020 5-year estimates. Table B25036.") 
...
write_rds(cf_basemap, "data/cf_basemap.rds")
...
ch_sfr <- st_read("data/shp/ch_sfr.shp", quiet = TRUE)
...
![Single-family rental homes in Chesterfield County](images/fig-sfr-map.png)
:::
...
#| fig-cap: "Average asking rent in Chesterfield County."
...
There are currently 19 proposed or under construction multifamily developments in the county---an estimated total of 5,039 rental homes[^part-2a-1-2]. Six of these properties are expected to be completed in 2022, while the remaining homes will be completed over the next two years.

[^part-2a-1-2]: Three properties do not have number of units listed and are slated for a 2027 completion date
