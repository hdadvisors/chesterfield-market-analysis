...
renters_plot <- gg_line(
  ...
  caption = "U.S. Census Bureau. American Community Survey. 2010-2020 5-year estimates. Table B25003.",
...
structure_plot <- gg_bar_col(
  ...
  caption = "U.S. Census Bureau. American Community Survey. 2010-2020 5-year estimates. Table B25032.",
...
bedroom_plot <- ggplot(b25042_data,
  ...
  labs(title = "Rental housing by bedrooms",
       caption = "U.S. Census Bureau. American Community Survey. 2010-2020 5-year estimates. Table B25042.") +
...
built_plot <- ggplot(b25036_data,
  ...
  labs(title = "Rental housing by year built",
       caption = "U.S. Census Bureau. American Community Survey. 2010-2020 5-year estimates. Table B25036.") 
