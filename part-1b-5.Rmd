...
```{r r1-base-map, fig.cap="Route 1 study area", out.width="300px", fig.align="center"}
...
# 
# r1_tiles <- get_static_tiles(
#   location = r1_tracts,
#   zoom = 11,
#   buffer_dist = 1000,
#   username = "jtknopf",
#   style_id = "ckjitm9ru101e19o7f5pfzwvx",
#   access_token = "pk.eyJ1IjoianRrbm9wZiIsImEiOiJjaXQwN2VybnEwbDFjMnVxcGE0djF4OGV3In0.V78HHJmSNpptsR-bAE2Adw"
# )
# 
# base_map <- tm_shape(r1_tiles) +
#   tm_rgb() +
#   tm_shape(r1_tracts) +
...
# 
# tmap_save(base_map, "images/r1-base-map.png", width=800)

knitr::include_graphics("images/r1-base-map.png")
...
In order to afford a home at this price, a household would need to make **\$56,358**. While this is 29 percent less than the income needed to afford the median sales price for the whole county, this is significantly above what most workers in the study area earn. The table below shows the assumptions made to calculate this figure.
...
r1_tract_names <- c("Census Tract 1003", "Census Tract 1004.03", "Census Tract 1004.04",
                    "Census Tract 1004.05", "Census Tract 1004.06", "Census Tract 1004.07",
