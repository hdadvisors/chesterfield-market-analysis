...
### Information on all HUD insurance programs
...
::: {.content-visible when-format="pdf"}
![HUD insured multifamily properties in Chesterfield County](images/fig-hud-insured-map.png)
:::
