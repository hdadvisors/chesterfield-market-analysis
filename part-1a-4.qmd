...
chesterfield_hcv <- chesterfield_tracts %>%
  ...
  select(GEOID,NAME, NAMELSAD, HCV_PUBLIC, HCV_PCT_RENTER_OCC_UNITS, INTPTLAT, INTPTLON, SHAPE_Length, SHAPE_Area, geometry)

mapview(
  chesterfield_hcv,
  zcol = "HCV_PCT_RENTER_OCC_UNITS",
  legend = T,
  layer.name = "Percent of occupied rental units with HCVs"
)

# htmlwidgets::saveWidget(hcv_map@map, "maps/hcv_map.html")

# Render map as html widget

# knitr::include_url("maps/hcv_map.html", height = "500px")
