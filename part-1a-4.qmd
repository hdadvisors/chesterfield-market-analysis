...
![Federally assisted rental properties in Chesterfield County](images/fig-subsidy-map.png)
:::
...
::: {.content-visible when-format="pdf"}
![Location and type of NOAH](images/fig-noah-map.png)
:::
...
::: {.content-visible when-format="pdf"}
![HCV utilization in Chesterfield County](images/fig-hcvs.png)
:::
