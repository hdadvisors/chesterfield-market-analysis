...
nhpd_plot <- ggplot(nhpd_units, aes(x = reorder(subsidy, -units), y = units, fill = subsidy))+
  geom_bar(stat = "identity") + 
  scale_fill_manual(values = c("blue", "red", "green", "orange"), breaks = c("LIHTC", "Section 8", "HUD Insured", "Section 202 or Section 236")) +
  labs(title = "Federally assisted units by subsidy type in Chesterfield County", fill = "Subsidy name") +
