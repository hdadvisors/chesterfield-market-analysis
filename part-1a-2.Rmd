...
As an example, we will estimate residual income for some of the most common household types and incomes^[Based on ACS 2020 5-year estimates, regional mean annual wages, and Chesterfield County wage data.]  :

*Homeowners*

* Married couple, aged 65 and over, with no kids, and a household income of \$61,777
* Married registered nurse and police officer, with two school-age kids, and a household income of \$136,410

*Renters*

* Single CCPS teacher, with no kids, and a household income of \$54,937
* Single female home health aide, with an infant and preschooler, and a household income of \$23,930

Based on current federal and state effective tax rates, the estimated total household income after taxes for these households will decrease slightly.^[Tax expenditures were calculated using the [Smart Asset Federal Income Tax Calculator](https://smartasset.com/taxes/income-taxes), setting location to Chesterfield County, and adjusting personal exemptions based on household size.]

Next, we determine the 2021 SSS monthly cost estimates depending on each household type utilizing the SSS dataset. The total monthly expenditures used exclude housing costs and tax expenditures as calculated by the Center for Women's Welfare at the University of Washington.^[We utilize a the Smart Asset Federal Income Tax Calculator rather than using the given tax expenditures because it does not account for the varying household incomes that determine tax rates.]
