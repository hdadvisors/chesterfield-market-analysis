...
The current HAI for Chesterfield County is `r hai`. This is lower than the latest national average published by NAR (150.3), indicating greater barriers to affordable homeownership in the county.
...
costs_table <- data.frame(x = costs_labels, y = costs_values) %>% 
...
summary_table <- data.frame(x = summary_labels, y = summary_values) %>% 
