...
```{r subsidy-map, fig.cap="Federally assisted rental properties in Chesterfield County"}
...
```{r subsidy-chart, fig.cap="Federally assisted units by subsidy type in Chesterfield County"}
...
```{r noah-map, fig.cap="Naturally occurring affordable rental properties in Chesterfield County"}
...
```{r hcvs, fig.cap="HCV utilization in Chesterfield County"}
