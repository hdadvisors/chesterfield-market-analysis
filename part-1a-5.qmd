...
ggplot(b25038_data,
  ...
  labs(title = "Percent of households by tenure by year moved into home", 
       x = "Year moved into unit",
       y = "Percent of households",
       caption = "Source: U.S. Census Bureau, American Community Survey, 2016-2020 5-year estimates. Table B25038.", 
       legend = "Tenure") + 
  theme(
    legend.position = "top",
