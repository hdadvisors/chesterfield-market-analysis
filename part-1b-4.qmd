...
#| fig-cap: "Median household income for renters in Chesterfield County"
...
plot_inc <- gg_bar(
  ...
  caption = "Sources: U.S. Census Bureau, American Community Survey, 5-year estimates, Table B25119",
...
```{r}
#| label: fig-cf-afford
#| fig-cap: "Affordable home sales price for renters in Chesterfield County"
...
cf_wages %>% 
  ...
  kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed"),
      latex_options = c("striped")) %>% 
  kableExtra::footnote(general = "CoStar Group, Inc. and Bureau of Labor Statistics, Occupational Employment and Wage Statistics, May 2021.",
                       footnote_as_chunk = T,
                       general_title = "Sources: ",
                       threeparttable = T)
