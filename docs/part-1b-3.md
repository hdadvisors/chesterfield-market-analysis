...
While other measures have their benefits in communicating the need to address housing affordability, the 30 percent standard has not only been shown to be accurate in representing the overall community, but it can be easily understood and applied at different scales. For these reasons, and for the range of demographic and socioeconomic crosstabs available for cost burden in CHAS data, we use this standard.
...
<img src="images/rentercb_income.png" width="100%" style="border:none;" />
...
<img src="images/hhtypecb.png" width="100%" style="border:none;" />
...
<img src="images/racecb.png" width="100%" style="border:none;" />
