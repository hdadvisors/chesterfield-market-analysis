...
<div class="figure">
<img src="part-1b-4_files/figure-html/med-sales-1.png" alt="Median single-family home sales price in Chesterfield County" width="100%" style="border:none;" />
<p class="caption">(\#fig:med-sales)Median single-family home sales price in Chesterfield County</p>
</div>
...
<caption>(\#tab:home-price)Calculated income needed to buy median-priced home in Chesterfield County</caption>
 <thead>
  <tr>
...
<div class="figure">
<img src="part-1b-4_files/figure-html/renter-income-afford-1.png" alt="Median household income and affordable home sales price for renters in Chesterfield County" width="100%" style="border:none;" />
<p class="caption">(\#fig:renter-income-afford)Median household income and affordable home sales price for renters in Chesterfield County</p>
</div>
...
<table class="table table-striped table-hover table-condensed" style="margin-left: auto; margin-right: auto;">
<caption>(\#tab:jobs-price)Maximum home sales price for five most common occupations in Chesterfield County</caption>
 <thead>
  <tr>
   <th style="text-align:left;"> Occupation </th>
   <th style="text-align:right;"> Jobs </th>
