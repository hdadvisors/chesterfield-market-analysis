...
```{r grocery-chart, fig.cap="Mean distance from apartments in Chesterfield County to food stores by type", eval=FALSE}
...
```{r r1-health-chart, fig.cap="Mean driving time from apartments in Chesterfield County to healthcare facility by market", eval=FALSE}
...
```{r jobs-chart, fig.cap="Percent of jobs by wage within 15 minute drive by rent type in Chesterfield County"}
...
gg_bar_col_facet(jobs_sum,
                 ...
                 y_labels = label_percent(),
                 col_labels = function(x) x,
                 title = "Percent of jobs by wage within 15 minute drive of apartments by rent type in Chesterfield County"
                 )
