...
![Recent multifamily developments by magisterial district](images/fig-recent-mf.png)
:::
...
status_timeline <- ggplot(status_units,
                          aes(x = Year,
                              y = Units,
                              fill = District)) + 
  geom_col() +
  ...
  labs(title = "Timeline of recent multifamily units by magisterial district",
                              caption = "Source: CoStar Group, Inc.")
...
noah_sum_district <- noah_by_district |> 
  ...
  summarise(Units = sum(units)) |> 
  mutate(MagDistName = gsub(" ", "\n", MagDistName))

noah_t_district <- ggplot(noah_sum_district,
                          aes(x = MagDistName,
                              y = Units,
                              fill = type)) +
  geom_col(position = "stack") +
  labs(title = "Type of market affordable housing by magisterial district",
       caption = "Sources: CoStar Group, Inc. and the Manufactured Housing Community Coalition of Virginia.",
       fill = "Type") +
  scale_y_continuous(labels = number_format(big.mark = ",")) +
...
::: {.content-visible when-format="pdf"}
![Affordable housing by magisterial district](images/fig-affordable-map.png)
:::
...
afftype <- ggplot(affordable_by_district,
                  aes(x = MagDistName,
                      ...
                      fill = subsidy_name)) +
  geom_col(position = "stack") + 
  labs(title = "Subsidy type by magisterial district",
       fill = "Subsidy type",
       y = "Affordable units",
