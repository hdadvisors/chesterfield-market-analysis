...
Based on an analysis of owner address and parcel address, there are an estimated 13,205 single-family home rentals in the county.
...
ggplot() + 
  geom_sf(data = rental_class, aes(fill = owner_location), color = NA) + 
