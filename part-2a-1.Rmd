...
CoStar provides quarterly average asking rents for properties listed in its multifamily database --- allowing for up-to-date information the changing rental market. When adjusted for inflation, rents in the county reached a 20 year high in Q4 2021 with an average asking rent of \$1,510
```{r costar-rents}
...
bedroom_rent <- read_csv("data/costar_br_existing_may_12.csv") |>
  ...
  mutate(rent = str_replace_all(rent, c("rent" = "Asking rent",
                                        "adj" = "Asking rent (inflation-adjusted)")))
...
There are currently 19 proposed or under construction multifamily developments in the county --- an estimated total of 5,039 rental homes. 
