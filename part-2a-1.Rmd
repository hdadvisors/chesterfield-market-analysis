...
```{r tenure, fig.cap="Number of renter households in Chesterfield County"}
...
```{r structure, fig.cap="Rental housing units by structure type"}
...
```{r bedrooms, fig.cap="Rental housing by bedrooms"}
...
```{r yearbuilt, fig.cap="Rental housing by year built"}
...
```{r sfr-map, fig.cap="Single-family rental homes in Chesterfield County"}
...
```{r sfr-magisterial, fig.cap="Single-family rentals as percent of all single-family homes by magisterial district"}
...
```{r sfr-owners-map, fig.cap="Location of single-family rental owners"}
...
```{r costar-rents, fig.cap="Average asking rent in Chesterfield County"}
...
```{r bedroom-rents, fig.cap="Average asking rent in Chesterfield County by bedroom"}
...
```{r permits, fig.cap="Annual building permits in Chesterfield County by structure type"}
...
```{r costar-construction, fig.cap="Upcoming rental units in Chesterfield County by delivery year"}
