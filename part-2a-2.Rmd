...
```{r noah-age, fig.cap="Market affordable housing by year built"}
...
```{r price-comparison-map, fig.cap="Map of average rent by property type", message=FALSE}
...
```{r pcomp-hist-county, fig.cap="Average asking rents by rent type"}
...
```{r pcomp-hist-dist, fig.cap="Number of properties by average rent by district"}
