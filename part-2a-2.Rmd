...
The Bermuda District, which includes the entirety of the Route One corridor, contains the largest number of market affordable rental properties
...
noah_t_district <- gg_bar_col(noah_by_district,
                              x_var = MagDistName,
                              y_var = units,
                              col_var = style)
