...
p_comp <- read_csv("data/costar_price_comparison.csv") |> 
  clean_names() |> 
  select(property_address, property_name, style, owner_name, number_of_units, avg_asking_unit, rent_type, market_segment,latitude, longitude) |> 
...
pcomp_hist_county <- gg_histogram_col(comp_by_district,
